...
field1 = config['mapping']['field1'] #id
field2 = config['mapping']['field2'] #title
field3 = config['mapping']['field3'] #content/abstract
docType = config['mapping']['field4'] #version number
